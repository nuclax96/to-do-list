...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   projectControllerFunction: () => (/* binding */ projectControllerFunction),\n/* harmony export */   taskControllerFunctions: () => (/* binding */ taskControllerFunctions)\n/* harmony export */ });\n/* harmony import */ var _dataHandler_projects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataHandler/projects */ \"./src/modules/dataHandler/projects.js\");\n/* harmony import */ var _dataHandler_task__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dataHandler/task */ \"./src/modules/dataHandler/task.js\");\n/* harmony import */ var _domHandler_main_populateMain__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./domHandler/main/populateMain */ \"./src/modules/domHandler/main/populateMain.js\");\n/* harmony import */ var _domHandler_main_taskModalFunctions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./domHandler/main/taskModalFunctions */ \"./src/modules/domHandler/main/taskModalFunctions.js\");\n/* harmony import */ var _domHandler_nav_addProjectModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./domHandler/nav/addProjectModal */ \"./src/modules/domHandler/nav/addProjectModal.js\");\n/* harmony import */ var _domHandler_nav_projectModalFunctions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./domHandler/nav/projectModalFunctions */ \"./src/modules/domHandler/nav/projectModalFunctions.js\");\n/* harmony import */ var _eventListeners__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./eventListeners */ \"./src/modules/eventListeners.js\");\n/* harmony import */ var _helperFunctions_clearContainer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./helperFunctions/clearContainer */ \"./src/modules/helperFunctions/clearContainer.js\");\n/* harmony import */ var _helperFunctions_localStorage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./helperFunctions/localStorage */ \"./src/modules/helperFunctions/localStorage.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst taskControllerFunctions = (() => {\r\n  // const createModal = function () {\r\n  //   taskModalFunctions.showModal();\r\n  // };\r\n\r\n  const openTaskModal = function () {\r\n    _domHandler_main_taskModalFunctions__WEBPACK_IMPORTED_MODULE_3__[\"default\"].showModal();\r\n  };\r\n  const closeTaskModal = function () {\r\n    _domHandler_main_taskModalFunctions__WEBPACK_IMPORTED_MODULE_3__[\"default\"].hideModal();\r\n  };\r\n  const taskSubmitController = function () {};\r\n\r\n  const addTask = function () {\r\n    const userTask = _dataHandler_task__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addTask();\r\n\r\n    //Form Validation Here , TO-DO\r\n\r\n    //local storage\r\n    _helperFunctions_localStorage__WEBPACK_IMPORTED_MODULE_8__[\"default\"].setLocalStorage(\"taskArr\", userTask);\r\n    _helperFunctions_localStorage__WEBPACK_IMPORTED_MODULE_8__[\"default\"].getAllItems(\"taskArr\");\r\n    //Clear Input Fields\r\n    _domHandler_main_taskModalFunctions__WEBPACK_IMPORTED_MODULE_3__[\"default\"].clearTaskModalValues();\r\n    //close the modal\r\n    _domHandler_main_taskModalFunctions__WEBPACK_IMPORTED_MODULE_3__[\"default\"].hideModal();\r\n    _dataHandler_task__WEBPACK_IMPORTED_MODULE_1__[\"default\"].displayTask();\r\n    _eventListeners__WEBPACK_IMPORTED_MODULE_6__.taskEventsListener.deleteBtnListener();\r\n  };\r\n  const deleteTask = function (e) {\r\n    const id = e.target.parentNode.dataset[\"id\"];\r\n    _dataHandler_task__WEBPACK_IMPORTED_MODULE_1__[\"default\"].deleteTask(\"taskArr\", id);\r\n    (0,_domHandler_main_populateMain__WEBPACK_IMPORTED_MODULE_2__.deleteTaskUsingId)(id);\r\n  };\r\n\r\n  return {\r\n    taskSubmitController,\r\n    openTaskModal,\r\n    closeTaskModal,\r\n    addTask,\r\n    deleteTask,\r\n  };\r\n})();\r\n\r\nconst projectControllerFunction = (() => {\r\n  const showProjectModal = function () {\r\n    (0,_helperFunctions_clearContainer__WEBPACK_IMPORTED_MODULE_7__[\"default\"])(\"modal\");\r\n    (0,_domHandler_nav_addProjectModal__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\r\n    _domHandler_nav_projectModalFunctions__WEBPACK_IMPORTED_MODULE_5__[\"default\"].showModal();\r\n    _eventListeners__WEBPACK_IMPORTED_MODULE_6__.projectEventListeners.projectModalListeners();\r\n  };\r\n\r\n  const addProject = function () {\r\n    _dataHandler_projects__WEBPACK_IMPORTED_MODULE_0__[\"default\"].addProject();\r\n  };\r\n\r\n  const closeProjectModal = function () {\r\n    _domHandler_nav_projectModalFunctions__WEBPACK_IMPORTED_MODULE_5__[\"default\"].hideModal();\r\n  };\r\n  return { addProject, showProjectModal, closeProjectModal };\r\n})();\r\n\r\n\n\n//# sourceURL=webpack://to-do-list/./src/modules/controller.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _domHandler_main_taskModalFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../domHandler/main/taskModalFunctions */ \"./src/modules/domHandler/main/taskModalFunctions.js\");\n/* harmony import */ var _domHandler_main_populateMain__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../domHandler/main/populateMain */ \"./src/modules/domHandler/main/populateMain.js\");\n/* harmony import */ var _model_task__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../model/task */ \"./src/modules/model/task.js\");\n/* harmony import */ var _helperFunctions_localStorage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helperFunctions/localStorage */ \"./src/modules/helperFunctions/localStorage.js\");\n\r\n\r\n\r\n\r\n\r\n\r\nconst taskDataHandler = (() => {\r\n  const addTask = function () {\r\n    let priority = 5; //default priority set to 5 if not supplied\r\n    // Get task input fields'\r\n    const inputValues = _domHandler_main_taskModalFunctions__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getAddTaskValues();\r\n    priority = inputValues.priority ? inputValues.priority : priority;\r\n    // Create task object\r\n    const userTask = new _model_task__WEBPACK_IMPORTED_MODULE_2__.Task(\r\n      inputValues.taskName,\r\n      inputValues.taskDueDate,\r\n      inputValues.taskCreateDate,\r\n      priority,\r\n      false\r\n    );\r\n    return userTask;\r\n  };\r\n\r\n  const displayTask = function () {\r\n    const tasksArr = _helperFunctions_localStorage__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getAllItems(\"taskArr\");\r\n    (0,_domHandler_main_populateMain__WEBPACK_IMPORTED_MODULE_1__.fillTaskContainer)(tasksArr);\r\n  };\r\n\r\n  const deleteTask = function (itemName, id) {\r\n    _helperFunctions_localStorage__WEBPACK_IMPORTED_MODULE_3__[\"default\"].deleteItemUsingId(itemName, id);\r\n  };\r\n\r\n  return { displayTask, deleteTask, addTask };\r\n})();\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (taskDataHandler);\r\n\n\n//# sourceURL=webpack://to-do-list/./src/modules/dataHandler/task.js?");
